...
def createTxWithBroadcast(_recv_pub, _amount, _comment=""):
    ...
    # debug:
    print("Complete")
    print(internal_storage["Miner"].state["Tx_pool"])
...
def newTx():
    ...
    miners_list = internal_storage["Miner"].tx_pool
    # state_list = internal_storage["Miner"].state["Tx_pool"]
...
def newBlock():
    ...
    if b.validate():
        ...
        print("Current length:", current_chain.chain_length)
